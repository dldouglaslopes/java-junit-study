...
public class LocacaoServiceTest {
	...
	public void alugarFilme () throws Exception {
		...
		PowerMockito.whenNew(Date.class).withNoArguments().thenReturn(DataUtils.obterData(5, 3, 2020));
		...
		error.checkThat(DataUtils.isMesmaData(locacao.getDataLocacao(), DataUtils.obterData(5, 3, 2020)), CoreMatchers.is(true));
		error.checkThat(DataUtils.isMesmaData(locacao.getDataRetorno(), DataUtils.obterData(6, 3, 2020)), CoreMatchers.is(true));
	}
